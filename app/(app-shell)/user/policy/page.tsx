      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:py-14">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/70 sm:text-base">
                This policy explains how Verse AI collects, uses, and protects data
        ...
        <div className="mt-8 space-y-6">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">1. Introduction</h2>
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">2. Information We Collect</h2>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-white/80 marker:text-white/30 sm:text-base">
              <li>
                ...
                email address, password, business name
              </li>
              <li>
                <strong className="text-white">Business Profile Data:</strong> company
                details, service descriptions, FAQs, documents, and knowledge-base
                content
              </li>
              <li>
                <strong className="text-white">Connected Account Data:</strong> Facebook
                Page ID, Instagram Business ID, WhatsApp Business Account ID, and access
                tokens
              </li>
              <li>
                <strong className="text-white">Billing Information:</strong> subscription
                status, invoices, and transaction metadata (payments handled by Stripe;
                no card data stored)
              </li>
              <li>
                <strong className="text-white">Calendar Data (optional):</strong>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-white/80 marker:text-white/30 sm:text-base">
              ...
              <li>May include message text, timestamps, and sender identifiers</li>
              <li>
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">3. How We Use Information</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-white/80 marker:text-white/30 sm:text-base">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">4. AI &amp; Automated Decision-Making</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-white/80 marker:text-white/30 sm:text-base">
              <li>Automated responses use only business-provided knowledge bases</li>
              <li>
                Private conversations are not used for public or shared model training
              </li>
              <li>
                Business owners are responsible for accuracy and compliance of responses
              </li>
            </ul>
          </section>
          ...
          {/* 6. Data Sharing */}
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">6. Data Sharing</h2>
          ...
          {/* 7. Data Retention */}
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">7. Data Retention</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-white/80 marker:text-white/30 sm:text-base">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">
              Requests can be sent to <strong className="text-white">[your support email]</strong>.
            </p>
          </section>

          {/* 9–13 */}
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">9. Data Security</h2>
            <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">
              We use encryption, secure APIs, access controls, and continuous monitoring.
              However, no system is 100% secure.
            </p>
          </section>

          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">10. Children’s Privacy</h2>
            <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">11. International Data Transfers</h2>
            <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">
              Data may be processed outside your country in compliance with applicable laws.
            </p>
          </section>

          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">12. Changes to This Policy</h2>
            <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="text-lg font-semibold sm:text-xl">13. Contact Information</h2>
