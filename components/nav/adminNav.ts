export const adminNav = [
  ...
  { label: "Users",     href: "/admin/users",     icon: "/users.png" },
  { label: "Integrations",   href: "/admin/integrations",   icon: "/integrations.png" },
  { label: "Company Profile",    href: "/admin/companyprofile",    icon: "/companyprofile.png" },
  { label: "Performance & Analytics",  href: "/admin/analytics",  icon: "/businessperformance.png" },
